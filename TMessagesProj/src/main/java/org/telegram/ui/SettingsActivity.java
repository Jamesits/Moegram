    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == textSizeRow || i == enableAnimationsRow || i == notificationRow || i == backgroundRow || i == numberRow ||
                    ...
                    i == switchBackendButtonRow || i == telegramFaqRow || i == contactsSortRow || i == contactsReimportRow || i == saveToGalleryRow || i == useSystemEmojiRow || i == stickersRow || i == cacheRow;
        }
            ...
            if (type == 0) {
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "Moegram v%s (%d)" + (BuildVars.DEBUG_VERSION ? " [TEST MODE]" : "") + "\nBased on Telegram for Android\nBuilt with \u2764 by James Swineson", pInfo.versionName, pInfo.versionCode));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
        ...
        public int getItemViewType(int i) {
            ...
            if (i == settingsSectionRow || i == supportSectionRow || i == messagesSectionRow || i == mediaDownloadSection || i == contactsSectionRow) {
                return 1;
            } else if (i == enableAnimationsRow || i == sendByEnterRow || i == saveToGalleryRow || i == autoplayGifsRow || i == useSystemEmojiRow) {
                return 3;
